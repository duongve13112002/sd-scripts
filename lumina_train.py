...
def train(args):
    ...
    if args.dataset_class is None:
        ...
        train_dataset_group, val_dataset_group = (
            config_util.generate_dataset_group_by_blueprint(blueprint.dataset_group, replay_ratio=args.replay_ratio)
        )
    else:
    ...
    if anti_forgetting.is_ewc_enabled(args) and args.ewc_reference_model_path is not None:
        ...
        ewc_reference_model = lumina_util.load_lumina_model(
