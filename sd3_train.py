...
def train(args):
    ...
    if anti_forgetting.is_ewc_enabled(args) and args.ewc_reference_model_path is not None:
        ...
        ewc_reference_sd = load_safetensors(
            args.ewc_reference_model_path, "cpu", args.disable_mmap_load_safetensors, model_dtype
        )
        ewc_reference_model = sd3_utils.load_mmdit(ewc_reference_sd, model_dtype, "cpu")
        del ewc_reference_sd
